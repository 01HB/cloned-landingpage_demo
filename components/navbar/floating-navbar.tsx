...
import { cn } from "@/lib/utils/mergecn";
import Link from "next/link";
import Image from "next/image";

import Applogo from "@/public/assets/applogo.svg";
import ApplogoBlue from "@/public/assets/applogo_blue.svg";

export const FloatingNav = ({
    isNavOpen,
    isSolutionsOpen,
    handleNav,
    handleMobileNavSolutions,
    className,
}: {
    isNavOpen: boolean;
    isSolutionsOpen: boolean;
    handleNav: () => void;
    handleMobileNavSolutions: () => void;
    className?: string;
}) => {
    const { scrollYProgress, scrollY } = useScroll();
    const [visible, setVisible] = useState(false);
    const [mobileMenuPostion, setMobileMenuPostion] = useState("85px");
    ...
    useMotionValueEvent(scrollYProgress, "change", (current) => {
        ...
        if (typeof current === "number") {
            ...
            if (scrollY.get() < 85) {
                const navpos = scrollY.get();
                setMobileMenuPostion(`${85 - navpos}px`);
            } else{
                if (direction < 0) {
                    setMobileMenuPostion("85px");
                } else {
                    setMobileMenuPostion("0px");
                }
            }
        ...
        <>
            <AnimatePresence mode="wait">
                <motion.div
                    ...
                    className={cn(
                        "bg-blue-main lg:bg-white lg:drop-shadow-nav max-lg:py-8 top-0 fixed w-full lg:pt-[17px] lg:pb-[25px] text-res-body-p1 lg:text-body-p1 z-[9999] font-inter",
                        className
                    )}
                >
                    <div id="main-navigation" className="relative">
                        <div className="container min-[480px]:max-md:max-w-[480px] min-[976px]:max-lg:max-w-none min-[1200px]:max-w-[1200px] flex items-center flex-wrap justify-between">
                            <h1>
                                <Link aria-label="Go to home page" href="#" rel="home">
                                    <Image
                                        ...
                                        priority
                                        className="w-[134px] h-auto object-contain lg:w-[170px] hidden lg:block"
                                    />
                                    <Image
                                        src={Applogo}
                                        alt="AnyTech"
                                        ...
                                        sizes="134px, (min-width: 1024px) 170px"
                                        priority
                                        className="w-[134px] h-auto object-contain lg:w-[170px] lg:hidden"
                                    />
                                </Link>
                            </h1>
                            <div className="flex items-center">
                                <nav className="desktop-menu max-lg:hidden" aria-label="Main navigation desktop">
                                    <ul className="flex text-white lg:text-blue-main">
                                        <li className="w-full whitespace-nowrap group lg:py-3 lg:px-6 lg:border-b border-white border-opacity-0 hover:border-opacity-100 transition-all duration-500 cursor-pointer !border-none">
                                            <span className="flex items-center justify-between">
                                                <span>Solutions</span>
                                                <svg
                                                    className="ml-2 mt-1 fill-white lg:fill-blue-main"
                                                    width="9"
                                                    height="6"
                                                    viewBox="0 0 9 6"
                                                    fill="none"
                                        ...
                                        <div className="ml-6 my-auto">
                                            <div className="relative lg:block hidden">
                                                <button className="rounded-[132px] flex items-center justify-center space-x-[8px] border px-[14px] py-[8px] lg:text-body-p1 text-res-body-p0 border-blue-main">
                                                    ...
                                                    <svg className="rotate-0 transition-transform duration-200" width="9" height="5" viewBox="0 0 9 5" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M4.35156 4.77344L1.16406 1.58594C0.929688 1.35156 0.929688 1 1.16406 0.789062L1.67969 0.25C1.91406 0.0390625 2.26562 0.0390625 2.47656 0.25L4.72656 2.52344L7 0.25C7.21094 0.0390625 7.5625 0.0390625 7.79688 0.25L8.3125 0.789062C8.54688 1 8.54688 1.35156 8.3125 1.58594L5.125 4.77344C4.91406 4.98438 4.5625 4.98438 4.35156 4.77344Z" fill="currentColor"></path>
                                                    </svg>
                                                </button>
                                            </div>
                                            ...
                                            <div className="lg:hidden block w-full">
                                                <div className="w-full border px-[14px] py-[8px] text-res-body-p1 text-white border-blue-main transition-all duration-75 rounded-[130px]">
                                                    <button className="flex justify-center items-center space-x-[8px] w-full">
                                                        ...
                                                        <svg className="rotate-0 transition-transform duration-300" width="9" height="5" viewBox="0 0 9 5" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path d="M4.35156 4.77344L1.16406 1.58594C0.929688 1.35156 0.929688 1 1.16406 0.789062L1.67969 0.25C1.91406 0.0390625 2.26562 0.0390625 2.47656 0.25L4.72656 2.52344L7 0.25C7.21094 0.0390625 7.5625 0.0390625 7.79688 0.25L8.3125 0.789062C8.54688 1 8.54688 1.35156 8.3125 1.58594L5.125 4.77344C4.91406 4.98438 4.5625 4.98438 4.35156 4.77344Z" fill="currentColor"></path>
                                                        </svg>
                                                    </button>
                                                </div>
                                ...
                                <button onClick={handleNav} type="button" className="cursor-pointer lg:hidden">
                                    {
                                        isNavOpen ?
                            ...
                            <Link href="/" className="bg-orange-main text-white hover:bg-orange-hover hidden max-lg:w-full max-lg:justify-center max-lg:mt-16 pl-6 pr-10 py-[13px] text-res-link lg:text-link lg:flex items-center group/highlight transition-all drop-shadow-button-primary hover:shadow-button-primary rounded-xs">
                                {`Contact Us`}
                                <svg
            ...
            <AnimatePresence mode="wait">
                <motion.div
                    animate={{
                        top: mobileMenuPostion,
                    }}
                    className={`fixed z-[5000] bg-[#1B76E9] w-full inset-x-0 py-8 px-[1.938rem] ${isNavOpen ? 'translate-x-0 lg:hidden' : '-translate-x-full'} transition-transform`}
                >
                    <ul className="flex items-center flex-col space-y-8">
                        <li className="w-full whitespace-nowrap group lg:py-3 lg:px-6 lg:border-b border-white border-opacity-0 hover:border-opacity-100 transition-all duration-500 cursor-pointer !border-none">
                            <button onClick={handleMobileNavSolutions} type="button" className="flex w-full items-center justify-between">
                                <span>Solutions</span>
                                <svg className="ml-2 mt-1 fill-white" width="9" height="6" viewBox="0 0 9 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M4.35156 5.27344C4.5625 5.48438 4.91406 5.48438 5.125 5.27344L8.3125 2.08594C8.54688 1.85156 8.54688 1.5 8.3125 1.28906L7.79688 0.75C7.5625 0.539062 7.21094 0.539062 7 0.75L4.72656 3.02344L2.47656 0.75C2.26562 0.539062 1.91406 0.539062 1.67969 0.75L1.16406 1.28906C0.929688 1.5 0.929688 1.85156 1.16406 2.08594L4.35156 5.27344Z"></path>
                                </svg>
                            </button>
                            <span className={`lg:absolute lg:top-full lg:bg-white lg:w-[240px] relative shadow-menu lg:text-blue-text rounded-xs ${isSolutionsOpen ? 'block' : 'hidden'}`}>
                                <ul className="flex flex-col relative lg:-mt-[1px] max-lg:mt-6">
                                    <li className="lg:border-t border-blue-light whitespace-nowrap first:border-none">
                                        <a className="hover:text-blue-main hover:transition-colors duration-200 py-3 lg:pl-[15px] pl-4 max-lg:pr-5 inline-block" href="/en/solutions/anycaas">
                                            <span className="flex res-body-p0 lg:text-body-p1">
                                                <svg className="w-2 -rotate-90 fill-theme-muted mr-2 lg:hidden" width="9" height="6" viewBox="0 0 9 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M4.35156 5.27344C4.5625 5.48438 4.91406 5.48438 5.125 5.27344L8.3125 2.08594C8.54688 1.85156 8.54688 1.5 8.3125 1.28906L7.79688 0.75C7.5625 0.539062 7.21094 0.539062 7 0.75L4.72656 3.02344L2.47656 0.75C2.26562 0.539062 1.91406 0.539062 1.67969 0.75L1.16406 1.28906C0.929688 1.5 0.929688 1.85156 1.16406 2.08594L4.35156 5.27344Z"></path>
                                                </svg>
                                                AnyCaaS
                                            </span>
                                    ...
                                    <li className="lg:border-t border-blue-light whitespace-nowrap first:border-none">
                                        <a className="hover:text-blue-main hover:transition-colors duration-200 py-3 lg:pl-[15px] pl-4 max-lg:pr-5 inline-block" href="/en/solutions/anybaas">
                                            <span className="flex res-body-p0 lg:text-body-p1">
                                                <svg className="w-2 -rotate-90 fill-theme-muted mr-2 lg:hidden" width="9" height="6" viewBox="0 0 9 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M4.35156 5.27344C4.5625 5.48438 4.91406 5.48438 5.125 5.27344L8.3125 2.08594C8.54688 1.85156 8.54688 1.5 8.3125 1.28906L7.79688 0.75C7.5625 0.539062 7.21094 0.539062 7 0.75L4.72656 3.02344L2.47656 0.75C2.26562 0.539062 1.91406 0.539062 1.67969 0.75L1.16406 1.28906C0.929688 1.5 0.929688 1.85156 1.16406 2.08594L4.35156 5.27344Z"></path>
                                                </svg>
                                    ...
                                    <li className="lg:border-t border-blue-light whitespace-nowrap first:border-none">
                                        <a className="hover:text-blue-main hover:transition-colors duration-200 py-3 lg:pl-[15px] pl-4 max-lg:pr-5 inline-block" href="/en/solutions/anypaas">
                                            <span className="flex res-body-p0 lg:text-body-p1">
                                                <svg className="w-2 -rotate-90 fill-theme-muted mr-2 lg:hidden" width="9" height="6" viewBox="0 0 9 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M4.35156 5.27344C4.5625 5.48438 4.91406 5.48438 5.125 5.27344L8.3125 2.08594C8.54688 1.85156 8.54688 1.5 8.3125 1.28906L7.79688 0.75C7.5625 0.539062 7.21094 0.539062 7 0.75L4.72656 3.02344L2.47656 0.75C2.26562 0.539062 1.91406 0.539062 1.67969 0.75L1.16406 1.28906C0.929688 1.5 0.929688 1.85156 1.16406 2.08594L4.35156 5.27344Z"></path>
                                                </svg>
                    ...
                    <Link href="/" className="border border-white bg-transparent lg:hidden max-lg:w-full max-lg:justify-center max-lg:mt-16 pl-6 pr-10 py-[13px] text-res-link lg:text-link flex items-center group/highlight transition-all hover:shadow-button-primary rounded-xs">
                        {`Contact Us`}
                        <svg
                            className="fill-white translate-x-3.5 transition-transform group-hover/highlight:translate-x-5"
                            width="7"
