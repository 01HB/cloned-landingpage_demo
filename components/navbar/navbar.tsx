...
const Navbar = () => {
    ...
    const handleMobileNavSolutions = () => {
            ...
            <div id="main-navigation" className="relative">
                <div className="container min-[480px]:max-md:max-w-[480px] min-[976px]:max-lg:max-w-none min-[1200px]:max-w-[1200px] flex items-center flex-wrap justify-between">
                    ...
                    <div className="flex items-center">
                        ...
                        <button onClick={handleNavOpen} type="button" className="cursor-pointer lg:hidden">
                            {
                                isOpen ?
                ...
                <nav className={`absolute z-[5000] top-[calc(95%_+_2rem)] bg-[#1B76E9] lg:hidden w-full inset-x-0 py-8 px-[1.938rem] ${isOpen ? 'translate-x-0' : '-translate-x-full'} transition-transform`}>
