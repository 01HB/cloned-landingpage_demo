...
const Navbar = () => {
    ...
    return (
        <header className="bg-transparent text-white max-lg:bg-blue-main max-lg:py-8 top-0 lg:absolute w-full lg:pt-[17px] lg:pb-[25px] text-res-body-p1 lg:text-body-p1 z-[9990] font-inter">
            <div id="main-navigation" className="relative">
                ...
                <FloatingNav isNavOpen={isOpen} handleNav={handleNavOpen} isSolutionsOpen={isSolutionsOpen} handleMobileNavSolutions={handleMobileNavSolutions} />
            </div>
        </header>
    );
}
